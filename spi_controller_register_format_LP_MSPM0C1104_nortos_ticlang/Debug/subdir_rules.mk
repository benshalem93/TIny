...
build-2024081361: ../spi_controller_register_format.syscfg
	...
	"C:/ti/ccs2031/ccs/utils/sysconfig_1.25.0/sysconfig_cli.bat" --script "C:/Users/User/workspace_ccstheia/spi_controller_register_format_LP_MSPM0C1104_nortos_ticlang/spi_controller_register_format.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_07_00_05/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '
