...
build-668204033: ../TIny.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/ccs2031/ccs/utils/sysconfig_1.25.0/sysconfig_cli.bat" --script "C:/Projects/TIny/spi_controller_register_format_LP_MSPM0C1104_nortos_ticlang/TIny.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_07_00_05/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

device_linker.cmd: build-668204033 ../TIny.syscfg
device.opt: build-668204033
device.cmd.genlibs: build-668204033
ti_msp_dl_config.c: build-668204033
ti_msp_dl_config.h: build-668204033
Event.dot: build-668204033
